...
$.each(JSON.parse(data), function (key, value) {
    $('#productList').append('<tr><td class="word">' + value.hotelname + '</td><td>' + value.foodname + '</td><td>' +
        ' <img class="foodimg" src="/css/Image/' + value.imageid + '" />' + '</td><td>' + value.price + '</td><td>' +
        value.quantity + '</td><td>' + value.quantity * value.price + '</td><td><button class="btn btn-danger delete ">Delete </button></td></tr>');
